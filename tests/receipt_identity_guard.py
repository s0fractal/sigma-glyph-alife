...
MUTATIONS = (
    ...
    ("experiments/alife-exp-011/results.json",
     ("result", "scores", "H1", "verdict"), "TRUE",
     "the food hypothesis flipped to true"),
    ("experiments/alife-exp-011/results.json",
     ("result", "scores", "H2", "leak_share"), 0.01,
     "the fed-then-buried leak shrunk under its threshold"),
    ("experiments/alife-exp-012c/results.json",
     ("result", "scores", "XC1", "verdict"), "HOLDS",
     "the phase-concordance verdict flipped"),
    ("experiments/alife-exp-012c/results.json",
     ("result", "scores", "XC3", "max_within_seed_spread"), 10,
     "collapse-timing spread shrunk under its comparator"),
    ("experiments/alife-exp-012d/results.json",
     ("result", "scores", "XD1", "verdict"), "HOLDS",
     "a prospective forecast flipped to holding"),
    ("experiments/alife-exp-012d/results.json",
     ("result", "scores", "XD3", "observed"), 4,
     "the sign-reversed arm margin flipped positive"),
